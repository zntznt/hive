...
values ('c0000000-0000-4000-8000-000000000001','los-jueves','Los Jueves','EUR','a1111111-1111-4111-8111-111111111111');
...
insert into expenses (id, event_id, payer_user_id, amount_cents, currency, note, created_by) values
  ('ee000000-0000-4000-8000-000000000001','e0000000-0000-4000-8000-000000000001','a1111111-1111-4111-8111-111111111111',3450,'EUR','Pizzas','a1111111-1111-4111-8111-111111111111'),
  ('ee000000-0000-4000-8000-000000000002','e0000000-0000-4000-8000-000000000001','a2222222-2222-4222-8222-222222222222',800,'EUR','Hielo y vasos','a2222222-2222-4222-8222-222222222222');
...
insert into settlements (event_id, from_user, to_user, amount_cents) values
  ('e0000000-0000-4000-8000-000000000001','a3333333-3333-4333-8333-333333333333','a1111111-1111-4111-8111-111111111111',1417);
